...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mAA16C26DAD891829846EB11127566A04B08650E3(__this, L_3, ((*(fsOption_1_t5307CE32C845EE97F1173CDBB2385C4B81D2A28A*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 62));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
